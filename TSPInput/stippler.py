...
if __name__ == '__main__':
    ...
    # Flattens into a grayscale image, 8 bit pixels, black and white
    density = imageio.imread(filename, mode='L')
    ...
    pdf_filename = os.path.join(
        dirname, basename + "-" + str(args.n_point) + "-stipple.pdf")
    png_filename = os.path.join(
        dirname, basename + "-" + str(args.n_point) + "-stipple.png")
    dat_filename = os.path.join(
        dirname, basename + "-" + str(args.n_point) + "-stipple.tsp")
    animation_filename = os.path.join(
        dirname, basename + "-" + str(args.n_point) + "-animation.gif")
